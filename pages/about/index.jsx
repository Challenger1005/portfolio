...
export const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: "Bachelor of Applied Science (BASc), Laravel, MERN, Python",
        stage: "2016 - 2018",
      },
      {
        title: "Bachelor of Applied Science (BASc), HTML, CSS, JavaScript, PHP",
        stage: "2012 - 2016",
      },
    ],
  },
  {
    ...
    info: [
      {
        title: "Senior Python Engineer | Heinsohn Business Technology",
        stage: "January 2023 - July 2023",
      },
      {
        title: "Senior Full-Stack Web Developer | Activeone",
        stage: "May 2021 - September 2022",
      },
      {
        title: "Sernior Web Developer | Pluriza",
        stage: "October 2018 - April 2021",
      },
    ],
  },
  {
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          <motion.h2
            ...
            className="h2"
          >
            Trust <span className="text-accent"> each other</span> birth
